...
<div class="w3-header">
    ...
    <div class="w3-sub">Sales Performance Dashboard · v5</div>
...
with tab2:
    ...
    with sub_tab2:
        ...
        if search_mode == "💡 Autocomplete (digita o seleziona)":
            # Costruisci elenco ricco "STORE — RS — CITTÀ (TIPO)"
            ...
            options_map = dict(zip(labels.tolist(), df_idx.index.tolist()))
            with col_sq:
                pick = st.selectbox(
                    "Cerca",
                    ["— digita per cercare —"] + sorted(options_map.keys()),
...
with tab4:
    ...
    <div style="text-align:center;color:#7B97BF;font-size:0.75rem;padding:1rem;">
        Wind3 Reload Dashboard v5 · Ambassador {zona_label} · {mese_str}<br>
